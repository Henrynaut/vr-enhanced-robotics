...
def videoInfo(inputVideo):
    inputWidth = int(inputVideo.get(cv2.cv.CV_CAP_PROP_FRAME_WIDTH))
    inputHeight = int(inputVideo.get(cv2.cv.CV_CAP_PROP_FRAME_HEIGHT))
    inputFrames = int(inputVideo.get(cv2.cv.CV_CAP_PROP_FRAME_COUNT))
    inputFPS = int(inputVideo.get(cv2.cv.CV_CAP_PROP_FPS))
